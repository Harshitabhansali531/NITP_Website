...
const CSEDepartment = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      {/* Top Header */}
      <div className="bg-white py-6 border-b border-gray-200 sticky top-16 z-30 shadow-sm">
        <div className="max-w-[1750px] mx-auto px-6 flex items-center justify-between">
          ...
          <h1 className="text-3xl md:text-4xl font-black text-center text-[#811919] uppercase tracking-wider">
      ...
      <div className="max-w-[1750px] mx-auto px-6 py-10">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          ...
          >
            ...
            {/* Carousel dots placeholder as seen in image */}
              ...
              <div className="space-y-8">
                {announcements.map((item, i) => (
                  <div key={i} className="group cursor-pointer">
                    ...
                    <h4 className="text-base font-bold text-navy-900 group-hover:text-[#811919] transition-colors leading-snug">
                      {item.title}
                    </h4>
        ...
        <div className="space-y-16">
          ...
          {/* Stats Grid - Floating Cards style as requested */}
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 pt-10">
            {stats.map((stat, i) => (
              ...
              >
                ...
                <div className="text-4xl font-black text-navy-950 mb-2">{stat.value}</div>
        ...
        {/* Bottom Navigation Sections for Modularity */}
        <div className="mt-24 grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            <div key={i} className="p-8 bg-white rounded-3xl shadow-sm border border-slate-100 hover:border-[#811919] transition-all group cursor-pointer">
              ...
              <h4 className="text-xl font-black text-navy-900 group-hover:text-[#811919] transition-colors mb-2">{item.title}</h4>
